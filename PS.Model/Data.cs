...
namespace PS.Model
{
    public class Data
    {
        ...
        {
            new Transaction{ Id = 1, PetId = 16, UserId = 4, CrietedDate = new DateTime(2019,21,08), TransType = TransTypes.ByCash  },
            new Transaction{ Id = 2, PetId = 6, UserId = 3, CrietedDate = new DateTime(2019,26,08), TransType = TransTypes.ByCash  },
            new Transaction{ Id = 3, PetId = 12, UserId = 2, CrietedDate = new DateTime(2019,21,08), TransType =  TransTypes.ByInsurance },
            new Transaction{ Id = 4, PetId = 11, UserId = 5, CrietedDate = new DateTime(2019,16,08), TransType =  TransTypes.ByInsurance },
            new Transaction{ Id = 5, PetId = 16, UserId = 2, CrietedDate = new DateTime(2019,29,08), TransType = TransTypes.ByCash  },
            new Transaction{ Id = 6, PetId = 29, UserId = 2, CrietedDate = new DateTime(2019,25,08), TransType = TransTypes.ByCash  },
            new Transaction{ Id = 7, PetId = 25, UserId = 3, CrietedDate = new DateTime(2019,23,08), TransType =  TransTypes.ByInsurance },
            new Transaction{ Id = 8, PetId = 24, UserId = 2, CrietedDate = new DateTime(2019,19,08), TransType = TransTypes.ByCash  },
            new Transaction{ Id = 9, PetId = 23, UserId = 4, CrietedDate = new DateTime(2019,22,08), TransType =  TransTypes.ByInsurance },
            new Transaction{ Id = 10, PetId = 10, UserId = 3, CrietedDate = new DateTime(2019,18,08), TransType =  TransTypes.ByInsurance },
            new Transaction{ Id = 11, PetId = 11, UserId = 5, CrietedDate = new DateTime(2019,15,08), TransType = TransTypes.ByCash  },
            new Transaction{ Id = 12, PetId = 7, UserId = 5, CrietedDate = new DateTime(2019,15,08), TransType =  TransTypes.ByInsurance },
            new Transaction{ Id = 13, PetId = 6, UserId = 3, CrietedDate = new DateTime(2019,17,08), TransType = TransTypes.ByCash  },
            new Transaction{ Id = 14, PetId = 28, UserId = 5, CrietedDate = new DateTime(2019,29,08), TransType =  TransTypes.ByInsurance },
            new Transaction{ Id = 15, PetId = 11, UserId = 2, CrietedDate = new DateTime(2019,29,08), TransType =  TransTypes.ByInsurance }
        };
