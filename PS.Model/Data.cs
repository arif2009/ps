...
namespace PS.Model
{
    public class Data
    {
        ...
        public static List<Transaction> transactions = new List<Transaction>
        {
            ...
            new Transaction{ Id = 5, PetId = 16, UserId = 2, CrietedDate = new DateTime(2019,08,29), TransType = TransTypes.ByCash  },
            ...
            new Transaction{ Id = 13, PetId = 6, UserId = 3, CrietedDate = new DateTime(2019,08,17), TransType = TransTypes.ByCash  },
            new Transaction{ Id = 14, PetId = 28, UserId = 5, CrietedDate = new DateTime(2019,08,29), TransType =  TransTypes.ByInsurance },
            new Transaction{ Id = 15, PetId = 11, UserId = 2, CrietedDate = new DateTime(2019,08,29), TransType =  TransTypes.ByInsurance }
        };
